...
import { Loader2, CheckCircle, Clock, Upload, ShieldCheck, FileText, ArrowRight, ExternalLink } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="space-y-8">
          <div className="text-center space-y-2">
            <h1 className="font-headline text-3xl font-bold text-accent uppercase">Application Roadmap</h1>
            <p className="text-muted-foreground italic">Track your progress to Canada recruitment drive.</p>
          </div>
          ...
          <Card className="border-none shadow-xl">
            <CardHeader className="bg-accent text-white rounded-t-lg">
              <CardTitle className="uppercase italic text-lg flex items-center gap-2">
                ...
                Current Phase: {currentApp.status.replace('_', ' ')}
              </CardTitle>
            </CardHeader>
